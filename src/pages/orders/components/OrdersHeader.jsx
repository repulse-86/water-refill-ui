...
export default function OrdersHeader({ viewMode = 'active', onViewModeChange, onAdd }) {
  ...
  return (
    <div className="flex items-center justify-between mb-8">
      <div>
        ...
        <p className="text-xs sm:text-sm text-slate-500">Track and manage order lifecycles.</p>
      </div>
      {viewMode === 'active' && (
